...
The framework combines Level of Traffic Stress, modeled travel demand, rider-specific routing preferences, optimal graph search, before-and-after intervention simulation, greedy package optimization, and robustness testing to evaluate infrastructure improvements across the network.
