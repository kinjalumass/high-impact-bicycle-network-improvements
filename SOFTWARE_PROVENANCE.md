...
This repository is methodologically self-contained: the README and `docs/technical_report.md` describe the complete network construction, demand modeling, routing, intervention-analysis, optimization, and robustness methodology used for the COMPSCI 683 project.
